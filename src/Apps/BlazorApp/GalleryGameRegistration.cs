...
public static class GalleryGameRegistration
{
    ...
    {
        Register(services, "breakout", "Breakout", "🧱",
        ...
        Register(services, "sink-sub", "Sink Sub", "🚢",
        ...
        Register(services, "asteroids", "Asteroids", "☄️",
        ...
        Register(services, "ui-gallery", "UI Gallery", "🧩",
