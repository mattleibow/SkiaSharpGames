...
/// </summary>
internal sealed class BreakoutGameOverScreen : GameScreenBase
{
    ...
    {
        // Apply the same coordinate transform as the play screen so text sits in game-space.
        ...
        DrawHelper.DrawCenteredText(canvas, $"Score: {_state.Score}", 32f, SKColors.White, GameWidth / 2f, 335f);
