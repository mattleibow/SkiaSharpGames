...
/// Populated by <see cref="Theatre"/> via the <c>Microsoft.Extensions.Options</c>
...
public sealed class StageOptions
{
    ...
    /// Set via <see cref="Theatre.SetStageSize(SKSize)"/> (or the two-float overload).
    ...
    /// Set via <see cref="Theatre.SetOpeningScene{TScreen}"/>.
    /// </summary>
