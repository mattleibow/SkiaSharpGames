...
{
    public HudAppearance<HudButton> Button { get; set; } = HudButtonAppearance.Default;
    public HudAppearance<HudCheckbox> Checkbox { get; set; } = HudCheckboxAppearance.Default;
    public HudAppearance<HudSwitch> Switch { get; set; } = HudSwitchAppearance.Default;
    public HudAppearance<HudSlider> Slider { get; set; } = HudSliderAppearance.Default;
    public HudAppearance<HudJoystick> Joystick { get; set; } = HudJoystickAppearance.Default;
    public HudAppearance<HudPointer> Pointer { get; set; } = HudPointerAppearance.Default;
    public HudAppearance<HudLabel> Label { get; set; } = HudLabelAppearance.Default;
...
{
    public static HudTheme Simple => new()
    {
        Button = HudButtonAppearance.Default,
        Checkbox = HudCheckboxAppearance.Default,
        Switch = HudSwitchAppearance.Default,
        Slider = HudSliderAppearance.Default,
        Joystick = HudJoystickAppearance.Default,
        Pointer = HudPointerAppearance.Default,
    };

    public static HudTheme BoldCute => new()
    {
        Button = HudButtonAppearance.Default with
        {
        ...
        Checkbox = HudCheckboxAppearance.Default with
        {
        ...
        Switch = HudSwitchAppearance.Default with
        {
        ...
        Slider = HudSliderAppearance.Default with
        {
        ...
        Joystick = HudJoystickAppearance.Default with
        {
    ...
    public static HudTheme Retro => new()
    {
        Button = HudButtonAppearance.Default with
        {
