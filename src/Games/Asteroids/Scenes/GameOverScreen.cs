...
internal sealed class GameOverScreen(AsteroidsGameState state, IDirector director) : Scene
{
    ...
    private readonly HudLabel _titleText = new() { Text = "GAME OVER", FontSize = 76f, Color = new SKColor(0xFF, 0x6B, 0x6B), Align = TextAlign.Center };
    private readonly HudLabel _scoreText = new() { FontSize = 32f, Color = SKColors.White, Align = TextAlign.Center };
    private readonly HudLabel _levelText = new() { FontSize = 24f, Color = HudDimColor, Align = TextAlign.Center };
