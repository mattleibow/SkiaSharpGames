...
internal sealed class Enemy : Actor
{
    ...
    private static readonly SKPaint CrossbowPaint = new()
    {
        Color = ColArrow,
        StrokeWidth = 1.5f,
        IsAntialias = true,
    };
    private static readonly SKPaint SwordPaint = new()
    {
        Color = new SKColor(0xCC, 0xCC, 0xCC),
        StrokeWidth = 3f,
        IsAntialias = true,
    };
    private static readonly SKPaint SpearPaint = new()
    {
        Color = new SKColor(0xCC, 0xCC, 0xCC),
        StrokeWidth = 2f,
        IsAntialias = true,
    };
    private static readonly SKPaint ArmPaint = new()
    {
        Color = new SKColor(0x8B, 0x5E, 0x2E),
        StrokeWidth = 3f,
        IsAntialias = true,
    };
    private static readonly SKPaint WheelPaint = new()
    {
        Color = new SKColor(0x55, 0x44, 0x22),
        IsAntialias = true,
    };
    private static readonly SKPaint TipPaint = new()
    {
        Color = new SKColor(0xCC, 0xCC, 0xCC),
        IsAntialias = true,
    };
    private static readonly SKPaint LegPaint = new()
    {
        Color = new SKColor(0xDD, 0xDD, 0xCC),
        StrokeWidth = 3f,
        IsAntialias = true,
    };
    private static readonly SKPaint SpotPaint = new()
    {
        Color = new SKColor(0x88, 0x88, 0x77),
        IsAntialias = true,
    };
    ...
    private readonly HudLabel _mooText = new()
    {
        Text = "MOO",
        FontSize = 10f,
        Color = new SKColor(0x55, 0x44, 0x22),
    ...
    private void DrawCatapult(SKCanvas canvas, SKColor col)
    {
        ...
        canvas.DrawRoundRect(
            SKRect.Create(-hw, -hh + 8f, Collider.Width, Collider.Height - 8f),
            3f,
            3f,
            BodyPaint
        );
    ...
    private void DrawRam(SKCanvas canvas, SKColor col)
    {
        ...
        BodyPaint.Color = col;
        canvas.DrawRoundRect(
            SKRect.Create(-hw, -hh, Collider.Width, Collider.Height - 6f),
            4f,
            4f,
            BodyPaint
        );
    ...
    private void DrawCow(SKCanvas canvas, SKColor col)
    {
        ...
        BodyPaint.Color = col;
        canvas.DrawRoundRect(
            SKRect.Create(-hw, -hh + 4f, Collider.Width, Collider.Height - 8f),
            5f,
            5f,
            BodyPaint
        );
        ...
        canvas.Save();
        canvas.Translate(0f, -hh);
        _mooText.Draw(canvas);
        canvas.Restore();
    }
}
