...
internal sealed class StartScreen(IDirector coordinator) : Scene
{
    ...
    private readonly UiLabel _instruction1 = new() { Text = "Move the bar left and right", FontSize = 22f, Color = DimColor, Align = TextAlign.Center, X = GameWidth / 2f, Y = 350f };
    private readonly UiLabel _instruction2 = new() { Text = "Each catch speeds up the next drop", FontSize = 22f, Color = DimColor, Align = TextAlign.Center, X = GameWidth / 2f, Y = 382f };
    private readonly UiLabel _instruction3 = new() { Text = "You have 3 lives", FontSize = 22f, Color = DimColor, Align = TextAlign.Center, X = GameWidth / 2f, Y = 414f };
    private readonly UiLabel _startPrompt = new() { Text = "Click, tap, or press Space to start", FontSize = 24f, Align = TextAlign.Center, X = GameWidth / 2f, Y = 474f };
