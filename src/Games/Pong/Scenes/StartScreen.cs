...
internal sealed class StartScreen : Scene
{
    ...
    private readonly HudLabel _leftControls = new()
    {
        Text = "Left: W / S",
        FontSize = 26f,
    ...
    private readonly HudLabel _rightControls = new()
    {
        Text = "Right: Up / Dn",
        FontSize = 26f,
    ...
    private readonly HudLabel _touchHint = new()
    {
        Text = "Touch or mouse: move the paddle on that side",
        FontSize = 20f,
        Color = DimColor,
        Align = TextAlign.Center,
        X = GameWidth / 2f,
    ...
    private readonly HudLabel _scoreHint = new()
    {
        Text = "First to 7 points wins",
        FontSize = 22f,
        Color = AccentColor,
        Align = TextAlign.Center,
        X = GameWidth / 2f,
