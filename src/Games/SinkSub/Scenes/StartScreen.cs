...
internal sealed class StartScreen(IDirector director) : Scene
{
    ...
    private readonly HudLabel _title = new() { Text = "SINK SUB", FontSize = 72f, Align = TextAlign.Center };
    private readonly HudLabel _subtitle = new() { Text = "Hunt submarines and avoid rising mines", FontSize = 26f, Color = AccentColor, Align = TextAlign.Center };
    private readonly HudLabel _instruction1 = new() { Text = "Move with mouse, touch, or arrow keys", FontSize = 20f, Color = DimColor, Align = TextAlign.Center };
    private readonly HudLabel _instruction2 = new() { Text = "Press Z or X to drop depth charges from the ship sides", FontSize = 20f, Color = DimColor, Align = TextAlign.Center };
