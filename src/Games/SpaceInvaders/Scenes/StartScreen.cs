...
{
    private readonly HudLabel _title = new() { Text = "SPACE INVADERS", FontSize = 72f, Color = AccentColor, Align = TextAlign.Center };
    private readonly HudLabel _subtitle = new() { Text = "Classic arcade invasion defense", FontSize = 26f, Color = SKColors.White, Align = TextAlign.Center };
    private readonly HudLabel _moveHint = new() { Text = "Move: Arrow keys or mouse / touch", FontSize = 22f, Color = HudDimColor, Align = TextAlign.Center };
    private readonly HudLabel _fireHint = new() { Text = "Fire: Space, Enter, or tap", FontSize = 22f, Color = HudDimColor, Align = TextAlign.Center };
