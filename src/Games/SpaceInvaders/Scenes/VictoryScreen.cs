...
internal sealed class VictoryScreen(SpaceInvadersGameState state, IDirector director) : Scene
{
    ...
    private readonly HudLabel _titleText = new() { Text = "WAVE CLEARED", FontSize = 72f, Color = AccentColor, Align = TextAlign.Center };
    private readonly HudLabel _scoreText = new() { FontSize = 32f, Color = SKColors.White, Align = TextAlign.Center };
    private readonly HudLabel _restartText = new() { Text = "Click, tap, or press Space to defend again", FontSize = 24f, Color = HudDimColor, Align = TextAlign.Center };
