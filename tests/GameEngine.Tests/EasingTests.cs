...
public class EasingTests
{
    ...
    [Fact]
    public void Linear_Midpoint_IsHalf() => Assert.Equal(0.5f, Easing.Linear(0.5f), precision: 5);

    // ── EaseIn ────────────────────────────────────────────────────────────

    [Fact]
    public void EaseIn_AtZero_ReturnsZero() => Assert.Equal(0f, Easing.EaseIn(0f), precision: 5);

    [Fact]
    public void EaseIn_AtOne_ReturnsOne() => Assert.Equal(1f, Easing.EaseIn(1f), precision: 5);

    [Fact]
    public void EaseIn_Midpoint_LessThanHalf() =>
        Assert.True(
            Easing.EaseIn(0.5f) < 0.5f,
    ...
    [Fact]
    public void EaseOut_AtZero_ReturnsZero() => Assert.Equal(0f, Easing.EaseOut(0f), precision: 5);

    [Fact]
    public void EaseOut_AtOne_ReturnsOne() => Assert.Equal(1f, Easing.EaseOut(1f), precision: 5);

    [Fact]
    public void EaseOut_Midpoint_GreaterThanHalf() =>
        Assert.True(
            Easing.EaseOut(0.5f) > 0.5f,
    ...
    [Fact]
    public void BounceOut_Segment1_t0() => Assert.Equal(0f, Easing.BounceOut(0f), precision: 5);
    ...
    [Fact]
    public void BackOut_AtZero_ReturnsZero() => Assert.Equal(0f, Easing.BackOut(0f), precision: 5);

    [Fact]
    public void BackOut_AtOne_ReturnsOne() => Assert.Equal(1f, Easing.BackOut(1f), precision: 4);
